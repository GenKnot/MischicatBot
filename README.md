...
- ~~音乐系统（YouTube / 哔哩哔哩点歌，队列，跨平台 cookie，固定播放列表 `data/playlist.txt`，`!playlist` 一键加载）~~
- ~~奇遇链系统（3条多阶段连续剧情：九尾灵狐4阶 / 上古墓陵3阶 / 流浪剑客3阶，跨探险进度持久化，完成获得称号/功法/永久属性加成，触发概率独立配置 `data/adventure_chains_config.json`）~~
...
服务器小、人少，世界就冷清。这次更新往世界里放进 **200~2000 个机器人修士**，他们有自己的性格，每天打工、修炼、突破，也会死，死了会有新人补上。真人的故事和他们的故事混在一起，就是江湖。

### 众生

机器人分三档：

- **炮灰** —— 大多数人。境界低、身上穷，寿元耗尽就坐化了
- **正常** —— 跟着普通玩家的节奏慢慢修
- **天骄** —— 少数人。有名有姓，修得快、打得狠，会上全服公告

每个机器人都有随机的性格（豪爽、阴鸷、贪财、痴丹、话痨、高冷……），说话、做事都不一样。道号按地域取风格，灵根决定他常待哪座城 —— 冰灵根的多在寒冰城，火灵根的多在赤炎城、丹霞谷。城里会显示当前有多少修士，同城修士列表里能看到他们。

机器人的属性成长模拟真人探险的收获，不会出现"修为很高、属性很低"的怪号。

### 江湖传闻

世界上发生的事会变成传闻，**机器人的和真人的都有，全部实名**：

> 听闻赤炎城散修「王铁柱」开炉三次，三次炸炉，现已闭门不出。
>
> 天骄「凌霜」于玄冰谷闭关百年，出关即入元婴。
>
> 归元镇炼气散修「张三」寿元耗尽，坐化于客栈之中，无人收尸。
>
> 「王铁柱」于落云城外劫杀散修「李四」，夺灵石八百。

- 在**茶馆**里可以翻看所有传闻
- 频道里**每游戏年播报一条**（游戏一年 = 现实 2 小时，一天 12 条），只播这一年最精彩的那一件
- 真人的事迹有保底名额，不会被机器人淹没
- 炸炉、突破失败、身死也会上传闻 —— 大家一起玩，被调侃也是乐趣。不想上传闻的可以自己关掉

### 天骄榜

真人和天骄一起排。天骄是你要追赶的标杆，**真人上榜全服播报「新晋天骄」**。

天骄也有自己的一生：出世、崛起，然后飞升或陨落，再由新秀补位。

### 与机器人互动

机器人不是背景板：

- **搭话 / 论道** —— 台词随他的性格和对你的好感变化
- **好感度** —— 聊天、送礼、帮忙会涨，得罪了会跌
- **请教** —— 关系够好，高境界的前辈会透露秘境、丹方的消息
- **切磋** —— 用他自己的属性和你过招
- **结仇** —— 得罪了阴鸷的人，传闻里会出现他放的狠话

### 劫杀

机器人每天打工几乎打满，**身上比较有钱**。你可以去打劫他、废他修为，甚至杀了他 —— 对真人也一样。

但这是江湖：

- 他会还手。**你先动的手，打输了由他按性格处置你**：豪爽的放你走，贪财的劫你的财，阴鸷的会让你重伤
- 机器人大部分钱存在钱庄，抢不走；贪财的、豪爽的身上带得多，谨慎的身上没什么油水
- 炮灰好杀但穷，天骄有钱但能打
- 滥杀会积累**恶名**：机器人不愿与你交易，正道修士见你就打；以大欺小所得打折、恶名翻倍
- 被杀者的至交、同门会记仇，挂出**悬赏** —— 真人也能接
- **拉帮结伙埋伏你**：记了仇的人会找来至交、同门，在你出城、赶路、进秘地的时候设伏。
  风声会先传出来（"近日有人在落云城外打听你的行踪"），你可以躲、可以绕路、可以叫上队友；
  以一敌三反杀了，那就是一段传奇
- 每一次劫杀都会上江湖传闻
...
utils/                        游戏逻辑层，不直接依赖 Discord
  adventure_chain.py              奇遇链逻辑（进度读写/奖励应用/触发检查/护符消耗）
  events/                     探险事件池（480个事件）
    ...
    adventure_chains/         奇遇链剧情文件
      chain_spirit_fox.py     九尾灵狐的约定（4阶段）
      chain_ancient_tomb.py   上古墓陵的秘密（3阶段）
      chain_wandering_sword.py 流浪剑客的传承（3阶段）
  ...
  views/                      Discord UI 组件（View/Button/Select）
    ...
    adventure_chain.py          奇遇链 UI（ChainStageView，选项/奖励/进度推进）
...
data/                         静态配置文件
  ...
  adventure_chains_config.json  奇遇链触发概率配置（可直接修改数字调整各链触发率）
